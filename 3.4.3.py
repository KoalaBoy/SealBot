# -*- coding: utf-8 -*-
# ============ Code by Seal Team Bot ==============
# ===== Don't delete our credit SEAL TEAM BOT =====
# =============== Please Respect ==================
# -------------- Our team members -----------------
# - Jaylien / KoalaBoy http://line.me/ti/p/~merdogs
# - neet1996 http://line.me/ti/p/~neet1996
# ############### Special Thanks ##################
# - Emika http://line.me/ti/p/~Jamerockzaza
...
||✒️ Url - ขอลิ้ง
||✒️ Wc - ข้อความต้อนรับ
||✒️ yt [text]- ค้นหายูทูป
||✒️ พูด [text]- กูเกิ้ลพูด
||===== ✯ คำสั่งแอดมิน ✯ =====||
...
#            print "MEMBER HAS JOIN THE GROUP"
        ...
        if op.type == 26:
            ...
            elif msg.text in ["Bot5 Gift","5 gift"]:
                msg.contentType = 9
                msg.contentMetadata={'PRDID': '3b92ccf5-54d3-4765-848f-c9ffdc1da020',
                                    'PRDTYPE': 'THEME',
                                    'MSGTPL': '5'}
...
#-----------------------------------------------
                ...
                cl.sendText(msg.to,"คนสร้างกลุ่ม " + str(ginfo.name) + " :\n" + ginfo.creator.displayName )
#----------------------------------------------- 
#-----------------------------------------------
        if op.type == 19:
            try:
